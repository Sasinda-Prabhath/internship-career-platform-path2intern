...
function JobCard({ job, index }) {
  ...
  return (
    <div className={`bg-white border border-gray-200 rounded-2xl p-5 card-lift flex flex-col gap-3 animate-fadeInUp`} style={{ animationDelay: `${index * 50}ms` }}>
      ...
      <Link to={`/job/${job._id}`} className="mt-auto w-full text-center text-sm font-medium text-blue-600 border border-blue-200 rounded-xl py-2 bg-blue-50 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:border-blue-600 hover:shadow-lg hover:shadow-blue-500/30 hover:-translate-y-1">View Job</Link>
    </div>
  );
}
