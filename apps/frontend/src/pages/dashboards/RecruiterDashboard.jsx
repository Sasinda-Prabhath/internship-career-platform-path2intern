...
const JobRow = ({ job, currentTime }) => {
    ...
    return (
        <div className="flex items-center gap-3 py-3 border-b border-gray-100 last:border-0">
            <div className="w-8 h-8 rounded-lg bg-green-100 text-green-700 font-bold text-xs flex items-center justify-center shrink-0">
...
const OrgActionCard = ({ to, icon, title, description, accent = "blue", disabled }) => {
    ...
    const content = (
        <>
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-xl shrink-0 ${c.icon}`}>{icon}</div>
            <div>
            ...
            <div className="bg-white border-b border-gray-200 px-8 py-8">
                <div className="max-w-7xl mx-auto flex items-start justify-between gap-4 flex-wrap">
                    ...
                    <Link to="/org/post-job"
                        className="bg-green-600 hover:bg-green-700 text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition-colors shadow-sm shrink-0 mt-1 flex items-center gap-2">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-5">
                        <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                ...
                                <div className="bg-white border border-gray-200 rounded-2xl p-5 flex items-start gap-4 hover:border-purple-300 hover:-translate-y-0.5 hover:shadow-md cursor-pointer transition-all duration-200"
                                    ...
                                    <div className="w-10 h-10 rounded-xl bg-purple-50 text-purple-600 font-bold text-xs flex items-center justify-center shrink-0">
                                        📄
                                    </div>
                                    <div>
                                ...
                                <OrgActionCard
                                    ...
                                    description="Manage all your roles and applications from one central page."
                                    accent="amber"
                                />
                                <OrgActionCard
                                    to="/org/review-applications"
                                    ...
                                    description="Shortlist, reject, and track students under each job role."
                                    accent="purple"
                                />
                                <OrgActionCard
                                    to="/simulation"
                        ...
                        {/* Tips card */}
                        <div className="bg-linear-to-br from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-5">
